      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            Text('\$${5.00.toStringAsFixed(2)}', style: const TextStyle(fontSize: 36, fontWeight: FontWeight.bold)),
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: const [Text('Car ID', style: TextStyle(color: Colors.grey)), Text('Car #B-42')]),
                    const Divider(),
